...
const celebrities = [
  {
    ...
    quote: "Сервис топ! Привезли мою BMW M5 CS из Германии, сэкономил 3 ляма!",
    videoViews: "1.2M",
    rating: 5,
  },
  {
    ...
    image: "https://via.placeholder.com/200x200",
    quote: "Ребята реально знают свое дело. Tesla из Китая пришла за месяц!",
    videoViews: "856K",
    rating: 5,
  },
  {
    ...
    role: "Автоэксперт",
    image: "https://via.placeholder.com/200x200",
    quote: "Профессионалы! Нашли редкий Porsche 911 GT3 RS в идеале",
    videoViews: "623K",
    rating: 5,
  },
  {
    ...
    role: "Автожурналист",
    image: "https://via.placeholder.com/200x200",
    quote: "Лучший сервис для покупки авто из США. Точка.",
    videoViews: "1.5M",
    rating: 5,
  },
  {
    ...
    role: "Чемпион UFC",
    image: "https://via.placeholder.com/200x200",
    quote: "Братья помогли с Range Rover из Дубая. Все четко, рекомендую!",
    videoViews: "3.2M",
    rating: 5,
  },
];
