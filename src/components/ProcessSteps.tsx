...
const steps = [
  {
    ...
    description: "Проверка по 240+ параметрам, доступ к закрытым аукционам",
  ...
  },
  {
    ...
    description: "ИИ торгуется за вас, 75% услуг бесплатны за счет экономии",
    duration: "1-3 дня"
  },
  {
    number: "03",
    ...
    description: "GPS-трекинг 24/7, фото/видео отчеты на каждом этапе",
    duration: "30-60 дней"
  },
  {
    number: "04",
    ...
    description: "Полное оформление документов, постановка на учет",
    duration: "3-5 дней"
  },
  {
    number: "05",
    ...
    description: "Гарантия 6 месяцев на двигатель и КПП, 5000 км на все системы",
    duration: "1 день"
  },
  {
    number: "06",
    ...
    description: "Членство в закрытом клубе, помощь с ТО и запчастями",
    duration: "Навсегда"
  }
];
